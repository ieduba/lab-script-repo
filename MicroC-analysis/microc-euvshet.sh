...
sample=$2
echo $sample
#bedin=`echo $zippedbedin | sed 's/.bed.gz/.bed/'`
echo $bedin
...
##	gunzip $zippedbedin
#	awk '$4 == "TssA" || $4 == "TssFlnk" || $4 == "TssFlnkU" || $4 == "TssFlnkD" || $4 == "Tx"|| $4 == "TxWk" || $4 == "EnhG1" || $4 == "EnhG2" || $4 == "EnhA1" || $4 == "EnhA2" || $4 == "EnhWk" || $4 == "ZNF/Rpts" {print $1 "\t" $2 "\t" $3}' $bedin > $eubed
#	awk '$4 == "Het" || $4 == "TssBiv" || $4 == "EnhBiv" || $4 == "ReprPC" || $4 == "ReprPCWk" || $4 == "Quies" {print $1 "\t" $2 "\t" $3}' $bedin > $hetbed
##	gzip $bedin
#fi
...
samtools view $hetbam > temphet.sam
samtools view $eubam > tempeu.sam
...
awk 'NR==FNR{A[$1]=$2;next} A[$1]{print}' temphet2.sam $pair > het-$pair
awk 'NR==FNR{A[$1]=$2;next} A[$1]{print}' tempeu2.sam $pair > eu-$pair

#rm temphet.sam tempeu.sam temphet2.sam tempeu2.sam
